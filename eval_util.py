...
def result_dict_for_single_example(image,
  ...
  output_dict = {
      ...
      'class_predictions_with_background': predicts['class_predictions_with_background'],
  }
  print(predicts['class_predictions_with_background'])
  detection_fields = fields.DetectionResultFields
  ...
  print(output_dict['class_predictions_with_background'])
  return output_dict
